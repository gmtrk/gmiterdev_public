...
test('UPGRADES includes the budget/kick/spawn levers the deriver reads', () => {
  for (const id of ['goldenChance', 'pegBudget', 'blockBudget', 'pegKick', 'spawnRate', 'midRamps', 'pegSpread']) {
