"""
Django settings for gmiterdev project.
...
INSTALLED_APPS = [
    ...
    'metaguess',
    'ricochet.apps.RicochetConfig',
    "sketchy.apps.SketchyConfig",
]
...
WSGI_APPLICATION = 'gmiterdev.wsgi.application'
